...
namespace smsg_MVC4.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: smsg_MVC4.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult LogOn(smsg_MVC4.Models.LogOnModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.LogOn);
        ...
        public override System.Web.Mvc.ActionResult Register(smsg_MVC4.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult ChangePassword(smsg_MVC4.Models.ChangePasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.ChangePassword);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
