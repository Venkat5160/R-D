...
namespace MvcContrib.Pagination
{
	...
	public static class PaginationHelper
	{
        ...
        public static IPagination<T> AsPagination<T>(this IOrderedQueryable<T> source, int pageNumber, int pageSize)
        {
            if (pageNumber < 1)
            {
                throw new ArgumentOutOfRangeException("pageNumber", "The page number should be greater than or equal to 1.");
        ...
        public static IPagination<T> AsPaginationExecute<T>(this IQueryable<T> source, int pageNumber, int pageSize)
        {
            if (pageNumber < 1)
            {
                throw new ArgumentOutOfRangeException("pageNumber", "The page number should be greater than or equal to 1.");
            ...
            var ret= new LazyPagination<T>(source, pageNumber, pageSize);
            ret.Execute();
            return ret;
        }

        public static IPagination<T> AsPagination<T>(this IEnumerable<T> source, int pageNumber, int pageSize, out int TotalItems)
		{
			if(pageNumber < 1)
			{
				throw new ArgumentOutOfRangeException("pageNumber", "The page number should be greater than or equal to 1.");
			...
			var ret=new LazyPagination<T>(source.AsQueryable(), pageNumber, pageSize);
