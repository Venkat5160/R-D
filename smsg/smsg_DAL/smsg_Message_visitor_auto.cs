...
namespace smsg_DAL
{
    ...
    using System.Text;
    public partial class smsg_Message_Visitor: FastDatabaseQuery.IPropertiesVisitor
    {
         ...
         public string Visited(FastDatabaseQuery.IReceiveVisitor i)
         {
            ...
            var item=i as smsg_Message;
            if(item == null)
                 throw new ArgumentException("visiting can not convert to  smsg_Message");
    
                string Format="{0}={1};";
                    sb.Append(string.Format(Format,"IDMessage",item.IDMessage) );
